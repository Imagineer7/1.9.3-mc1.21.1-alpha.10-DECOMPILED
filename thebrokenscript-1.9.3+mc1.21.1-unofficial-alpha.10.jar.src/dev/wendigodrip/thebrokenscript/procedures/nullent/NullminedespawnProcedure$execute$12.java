...
/*     */ public final class NullminedespawnProcedure$execute$12
/*     */ {
...
/* 162 */     return ((Number)$tmp0.invoke(p0)).doubleValue(); } private static final double compareDistOf$lambda$0(double $_x, double $_y, double $_z, Entity _entcnd) {
/* 163 */     Intrinsics.checkNotNull(_entcnd); return _entcnd.distanceToSqr(
/* 164 */         $_x, 
/* 165 */         $_y, 
/* 166 */         $_z);
/*     */   }
