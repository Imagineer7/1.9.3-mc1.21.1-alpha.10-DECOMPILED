...
/*     */ public final class NullminedespawnProcedure$execute$10
/*     */ {
...
/* 142 */     return ((Number)$tmp0.invoke(p0)).doubleValue(); } private static final double compareDistOf$lambda$0(double $_x, double $_y, double $_z, Entity _entcnd) {
/* 143 */     Intrinsics.checkNotNull(_entcnd); return _entcnd.distanceToSqr(
/* 144 */         $_x, 
/* 145 */         $_y, 
/* 146 */         $_z);
/*     */   }
