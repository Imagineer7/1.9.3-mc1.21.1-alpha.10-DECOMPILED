...
/*     */ public final class TheObliterationOnEntityTickUpdateProcedure$execute$entity2$2
/*     */ {
...
/* 130 */     return ((Number)$tmp0.invoke(p0)).doubleValue(); } private static final double compareDistOf$lambda$0(double $_x, double $_y, double $_z, Entity _entcnd) {
/* 131 */     Intrinsics.checkNotNull(_entcnd); return _entcnd.distanceToSqr(
/* 132 */         $_x, $_y, $_z);
/*     */   }
/*     */ }


/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3+mc1.21.1-unofficial-alpha.10.jar!\dev\wendigodrip\thebrokenscript\procedures\TheObliterationOnEntityTickUpdateProcedure$execute$entity2$2.class
