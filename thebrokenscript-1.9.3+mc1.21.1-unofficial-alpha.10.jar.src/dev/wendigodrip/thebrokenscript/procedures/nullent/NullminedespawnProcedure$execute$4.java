...
/*    */ public final class NullminedespawnProcedure$execute$4
/*    */ {
...
/* 83 */     return ((Number)$tmp0.invoke(p0)).doubleValue(); } private static final double compareDistOf$lambda$0(double $_x, double $_y, double $_z, Entity _entcnd) {
/* 84 */     Intrinsics.checkNotNull(_entcnd); return _entcnd.distanceToSqr(
/* 85 */         $_x, 
/* 86 */         $_y, 
/* 87 */         $_z);
/*    */   }
