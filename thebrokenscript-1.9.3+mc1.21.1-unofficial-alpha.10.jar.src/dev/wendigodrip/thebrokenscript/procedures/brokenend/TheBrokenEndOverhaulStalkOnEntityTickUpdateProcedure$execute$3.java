...
/*    */ public final class TheBrokenEndOverhaulStalkOnEntityTickUpdateProcedure$execute$3
/*    */ {
...
/* 53 */     return ((Number)$tmp0.invoke(p0)).doubleValue(); } private static final double compareDistOf$lambda$0(double $_x, double $_y, double $_z, Entity _entcnd) {
/* 54 */     Intrinsics.checkNotNull(_entcnd); return _entcnd.distanceToSqr(
/* 55 */         $_x, 
/* 56 */         $_y, 
/* 57 */         $_z);
/*    */   }
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3+mc1.21.1-unofficial-alpha.10.jar!\dev\wendigodrip\thebrokenscript\procedures\brokenend\TheBrokenEndOverhaulStalkOnEntityTickUpdateProcedure$execute$3.class
