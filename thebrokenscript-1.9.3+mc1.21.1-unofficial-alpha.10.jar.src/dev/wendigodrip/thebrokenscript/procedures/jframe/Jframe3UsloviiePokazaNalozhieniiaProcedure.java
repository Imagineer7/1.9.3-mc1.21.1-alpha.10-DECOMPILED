...
/*    */   }
/*    */   @NotNull
/*    */   public static final Jframe3UsloviiePokazaNalozhieniiaProcedure INSTANCE = new Jframe3UsloviiePokazaNalozhieniiaProcedure();
/*    */   @JvmStatic
...
/*    */ 
/*    */       
/* 39 */       !world.getEntitiesOfClass(Jframe3entityEntity.class, AABB.ofSize(new Vec3(x, y, z), 300.0D, 300.0D, 300.0D), Jframe3UsloviiePokazaNalozhieniiaProcedure::execute$lambda$0::execute$lambda$1).isEmpty(); } private static final boolean execute$lambda$0(Jframe3entityEntity e) { return true; } private static final boolean execute$lambda$1(Function1 $tmp0, Object p0) { return ((Boolean)$tmp0.invoke(p0)).booleanValue(); }
/*    */ 
/*    */ }


/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3+mc1.21.1-unofficial-alpha.10.jar!\dev\wendigodrip\thebrokenscript\procedures\jframe\Jframe3UsloviiePokazaNalozhieniiaProcedure.class
