...
/*    */ @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000\030\n\002\030\002\n\002\020\000\n\002\b\003\n\002\020\002\n\000\n\002\030\002\n\000\bÇ\002\030\0002\0020\001B\t\b\002¢\006\004\b\002\020\003J\020\020\004\032\0020\0052\006\020\006\032\0020\007H\007¨\006\b"}, d2 = {"Ldev/wendigodrip/thebrokenscript/client/screens/SomethingiswrongOverlay;", "", "<init>", "()V", "eventHandler", "", "event", "Lnet/neoforged/neoforge/client/event/RenderGuiEvent$Pre;", "thebrokenscript"})
/*    */ public final class SomethingiswrongOverlay {
...
/* 36 */     RenderSystem.setShader(SomethingiswrongOverlay::eventHandler$lambda$0);
...
/* 44 */     Intrinsics.checkNotNull(world); if (CheckForScareEntityProcedure.execute((LevelAccessor)world, x, y, z)) {
/* 45 */       event.getGuiGraphics()
/* 46 */         .blit(
/* 47 */           TBSConstants.id("textures/screens/output-onlinepngtools.png"), 
/* 48 */           0, 
/* 49 */           0, 
/* 50 */           0.0F, 
/* 51 */           0.0F, 
...
/*    */   
/*    */   @NotNull
/*    */   public static final SomethingiswrongOverlay INSTANCE = new SomethingiswrongOverlay();
/*    */   
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3+mc1.21.1-unofficial-alpha.10.jar!\dev\wendigodrip\thebrokenscript\client\screens\SomethingiswrongOverlay.class
