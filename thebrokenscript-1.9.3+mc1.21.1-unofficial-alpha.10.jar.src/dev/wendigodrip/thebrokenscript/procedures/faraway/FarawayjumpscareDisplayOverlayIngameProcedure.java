...
/*    */   }
/*    */   @NotNull
/*    */   public static final FarawayjumpscareDisplayOverlayIngameProcedure INSTANCE = new FarawayjumpscareDisplayOverlayIngameProcedure();
/*    */   @JvmStatic
...
/*    */ 
/*    */       
/* 39 */       !world.getEntitiesOfClass(JumposcrooooEntity.class, AABB.ofSize(new Vec3(x, y, z), 500.0D, 500.0D, 500.0D), FarawayjumpscareDisplayOverlayIngameProcedure::execute$lambda$0::execute$lambda$1).isEmpty(); } private static final boolean execute$lambda$0(JumposcrooooEntity e) { return true; } private static final boolean execute$lambda$1(Function1 $tmp0, Object p0) { return ((Boolean)$tmp0.invoke(p0)).booleanValue(); }
/*    */ 
/*    */ }


/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3+mc1.21.1-unofficial-alpha.10.jar!\dev\wendigodrip\thebrokenscript\procedures\faraway\FarawayjumpscareDisplayOverlayIngameProcedure.class
