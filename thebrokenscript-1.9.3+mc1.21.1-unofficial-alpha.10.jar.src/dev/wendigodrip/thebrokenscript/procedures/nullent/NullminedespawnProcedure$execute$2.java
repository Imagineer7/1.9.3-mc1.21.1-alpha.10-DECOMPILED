...
/*    */ public final class NullminedespawnProcedure$execute$2
/*    */ {
...
/* 65 */     return ((Number)$tmp0.invoke(p0)).doubleValue(); } private static final double compareDistOf$lambda$0(double $_x, double $_y, double $_z, Entity _entcnd) {
/* 66 */     Intrinsics.checkNotNull(_entcnd); return _entcnd.distanceToSqr(
/* 67 */         $_x, 
/* 68 */         $_y, 
/* 69 */         $_z);
/*    */   }
